 ...
 * @public
 */
export declare type SVGAttributesAsMotionValues = MakeMotion<SVGAttributesWithoutMotionProps>;
 ...
 * @public
 */
export declare interface SVGMotionProps extends SVGAttributesAsMotionValues, Omit<MotionProps, "positionTransition"> {
}
...
declare type UseFunctionalityComponents<P = {}> = (props: P & MotionProps, values: MotionValuesMap, controls: ValueAnimationControls<P>, ref: RefObject<Element>, style: CSSProperties, isStatic?: boolean) => ReactElement<P>[];
